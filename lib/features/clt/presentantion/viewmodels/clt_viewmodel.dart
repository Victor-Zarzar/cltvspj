...
import 'package:cltvspj/features/clt/domain/clt_calculator.dart';
import 'package:cltvspj/features/clt/domain/entities/clt_entity.dart';
import 'package:cltvspj/features/clt/presentantion/reports/clt_report_builder.dart';
...
class CltViewModel extends ChangeNotifier {
  ...
  Future<void> _saveData(double salary, double benefits) async {
    final model = CltEntity(salaryClt: salary, benefits: benefits);
