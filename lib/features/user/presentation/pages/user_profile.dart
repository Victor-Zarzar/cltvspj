...
import 'package:cltvspj/features/user/presentation/widgets/body_user_profile.dart';
import 'package:cltvspj/features/user/presentation/widgets/user_popup_menu.dart';
...
import 'package:cltvspj/shared/widgets/custom_button.dart';
import 'package:cltvspj/shared/widgets/input_field.dart';
...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final controller = Provider.of<UserViewModel>(context, listen: false);
      controller.loadUser();
    });
  }
  ...
  Widget _buildUserProfileContent(
    ...
    return Consumer2<UiProvider, UserViewModel>(
